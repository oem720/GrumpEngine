...
namespace GrumpEngine
{
    ...
    public static class EventCoordinator
    {
        ...
        public static void RaiseEvent(object sender, EventHandle handle, GridPoint pos, Directions dir)
        {
            ...
            pbea.X = pos.X;
            pbea.Y = pos.Y;
            typeof(EventCoordinator).GetMethod(handle.ToString()).Invoke(null, new[] { sender, dir, pbea });
        }

        private static void On_Tile_Enter(object sender, Directions dir, PositionBasedEventArgs pbea)
        {

        }

        private static void On_Tile_Exit(object sender, Directions dir, PositionBasedEventArgs pbea)
        {
